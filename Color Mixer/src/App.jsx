...
function App() {
  ...
  return (
    ...
    <div>
      ...
      <input  value={r} type="range" onChange={(event)=>setR(event.target.value)} min={0} max={255}></input>
      <br/>
      <br/>
      <label htmlFor="">Green</label>
      <input value={g} type="range" onChange={(event)=>setG(event.target.value)} min={0} max={255}></input>
      <br/>
      <br/>
      <label htmlFor="">Blue</label>
      <input value={b} type="range" onChange={(event)=>setB(event.target.value)} min={0} max={255}></input>
